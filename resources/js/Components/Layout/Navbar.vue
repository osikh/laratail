...
import {
    ...
    IconArrowRightToBracketOutline,
    IconLaptopCodeOutline,
    IconUserSettingsOutline,
    IconSunOutline,
    IconMoonOutline
        ...
        <div class="flex flex-wrap justify-between items-center">
            ...
            <div class="flex items-center lg:order-2">
                <form action="#" method="GET" class="hidden md:block md:pl-2">
                    ...
                    <div class="relative md:w-64 lg:w-[500px]">
            ...
            <div class="flex items-center lg:order-3">
                ...
                <button @click="toggleDarkMode" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700
                        focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700
                        rounded-lg text-sm p-2.5">
                    <IconSunOutline v-if="isDarkMode" class="w-5 h-5" />
                    <IconMoonOutline v-if="!isDarkMode" class="w-5 h-5" />
                </button>
                <button type="button"
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                    ...
                    <div class="py-3 px-4">
                        ...
                        <span class="flex items-center text-sm text-gray-900 truncate dark:text-white">
                            {{ $page.props.auth.user.email }}
                            <IconCheckCircleOutline
                                v-if="$page.props.jetstream.hasEmailVerification && $page.props.auth.user.email_verified_at"
                                class="ms-1 w-5 h-5 text-green-500" />
                            <IconCloseCircleOutline
                                v-if="$page.props.jetstream.hasEmailVerification && !$page.props.auth.user.email_verified_at"
                                class="ms-1 w-5 h-5 text-red-500" />
                        </span>
                    </div>
                    <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                        <li>
                            <a :href="route('profile.show')"
                                ...
                                <IconUserSettingsOutline class="mr-2 w-5 h-5 text-gray-400" />
                                Account Settings
                            </a>
                        </li>
                        <li>
                            <a v-if="$page.props.jetstream.hasApiFeatures" :href="route('api-tokens.index')"
                                class="flex items-center py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                <IconLaptopCodeOutline class="mr-2 w-5 h-5 text-gray-400" />
                                API Token
                            </a>
                        </li>
                        <li>
                            ...
                            <form @submit.prevent="logout">
                                <button type="submit"
                                    class="flex items-center w-full py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                    <IconArrowRightToBracketOutline class="mr-2 w-5 h-5 text-gray-400" />
                                    Logout
                                </button>
                            </form>
                        </li>
